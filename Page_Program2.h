...
<table class="cent">
<tr>
<td><a href="program1.html"  class="btn btn--l btn--blue">&larr;</a></td>
<td align="center"><input type="submit" style="width:150px" class="btn btn--l btn--blue" value="Save"></td>
<td align="right"><a href="program3.html"  class="btn btn--l btn--blue">&rarr;</a></td>
</tr>
</table>
</form>
...
window.onload = function ()
{
	load("style.css","css", function() 
	{
		...
		{
				setValues("/admin/program_values2");
...
whichMemoryBank(2);
	...
	server.send ( 200, "text/html", PAGE_Program2 ); 
	Serial.println(__FUNCTION__);
}

void send_programator_values2_html()
{
whichMemoryBank(2);
	String values ="";
