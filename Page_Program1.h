...
const char PAGE_Program1[] PROGMEM = R"=====(
<title>TERMIKUS</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1" />
<div class="tiCen">
<a href="admin.html" class="btn btn--m btn--blue">&uarr;</a>
<a href="#" class="btn btn--m act">1</a><a href="program2.html" class="btn btn--m btn--blue">2</a><a href="program3.html" class="btn btn--m btn--blue">3</a><a href="program4.html" class="btn btn--m btn--blue">4</a><a href="program5.html" class="btn btn--m btn--blue">5</a><a href="program6.html" class="btn btn--m btn--blue">6</a><a href="program7.html" class="btn btn--m btn--blue">7</a><a href="program8.html" class="btn btn--m btn--blue">8</a>
</div>
<hr>
...
<tr><td class="slidecontainer" colspan=3><input type="range" min="0" max="35" value="" step="0.5" class="slider" id="myRange"></td></tr>
<tr><td align="left" colspan="2"><br></td></tr>
...
<tr><td align="right">Stop time:</td><td><select id="toffhour" name="toffhour">
...
<table class="cent">
<tr><td><a href="program8.html" class="btn btn--l btn--blue">&larr;</a></td><td align="center"><input type="submit" style="width:150px" class="btn btn--l btn--blue" value="Save"></td><td align="right"><a href="program2.html" class="btn btn--l btn--blue">&rarr;</a></td></tr>
</table>
</form>
...
window.onload = function ()
{
 ...
 {
 setValues("/admin/program_values1");
...
void save_program1_values()
{
  if (server.args() > 0 )  {// Save Settings
    whichMemoryBank(1);  // change the prog number (+8) (memory bank) in case enableSafety
    ...
    midnightCheck(memoryBank); // funkcja zamienia godz. 00:00 ustawioną na programStop na 23:59
    writeProgram(memoryBank); //funkcja zapisująca do EEPROM
  }
  server.send ( 200, "text/html", PAGE_Program1 ); 
  Serial.println(__FUNCTION__);
}

void send_programator_values1_html()
{
whichMemoryBank(1);
  String values ="";
