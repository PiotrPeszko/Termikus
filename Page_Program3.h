...
//  HTML PAGE
//
const char PAGE_Program3[] PROGMEM =  R"=====(
...
<table class="cent">
<tr>
<td><a href="program2.html"  class="btn btn--l btn--blue">&larr;</a></td>
<td align="center"><input type="submit" style="width:150px" class="btn btn--l btn--blue" value="Save"></td>
<td align="right"><a href="program4.html"  class="btn btn--l btn--blue">&rarr;</a></td>
</tr>
</table>
</form>
...
window.onload = function ()
{
	load("style.css","css", function() 
	{
		...
		{
				setValues("/admin/program_values3");
...
void save_program3_values()
{
	...
	server.send ( 200, "text/html", PAGE_Program3 ); 
	Serial.println(__FUNCTION__);
}

void send_programator_values3_html()
{
whichMemoryBank(3);
	String values ="";
