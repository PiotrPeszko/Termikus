...
//  HTML PAGE
//
const char PAGE_Program6[] PROGMEM =  R"=====(
...
<a href="program1.html"  class="btn btn--m btn--blue">1</a><a href="program2.html"  class="btn btn--m btn--blue">2</a><a href="program3.html"  class="btn btn--m btn--blue">3</a><a href="program4.html"  class="btn btn--m btn--blue">4</a><a href="program5.html"  class="btn btn--m btn--blue">5</a><a href="#" class="btn btn--m act">6</a><a href="program7.html"  class="btn btn--m btn--blue">7</a><a href="program8.html"  class="btn btn--m btn--blue">8</a>
</div>
<hr>
...
<table class="cent">
<tr>
<td><a href="program5.html" class="btn btn--l btn--blue">&larr;</a></td>
<td align="center"><input type="submit" style="width:150px" class="btn btn--l btn--blue" value="Save"></td>
<td align="right"><a href="program7.html" class="btn btn--l btn--blue">&rarr;</a></td>
</tr>
</table>
</form>
<script>
...
window.onload = function ()
{
  load("style.css","css", function() 
  {
    ...
    {
        setValues("/admin/program_values6"); 
...
void save_program6_values()
{
   ...
   // SafeModeTimeOutCounter = 0;
	...
	server.send ( 200, "text/html", PAGE_Program6 ); 
	Serial.println(__FUNCTION__);
}

void send_programator_values6_html()
{
  whichMemoryBank(6);
	String values ="";
